...
namespace DevotedLlama.CircleGenerator {
    public class DashCircle : CircleTemplate {
        public DashCircle(Mesh mesh, CircleData circleData) : base(mesh, circleData) { }
        ...
        protected override List<IndexValue> DeriveTriangleIndices(int triangleIndex, int vertexIndex) {
            ...
            list.Add(new IndexValue(ti + 2, vi + CircleData.PolygonQuantity * 2));
            list.Add(new IndexValue(ti + 3, vi + CircleData.PolygonQuantity * 2));
            list.Add(new IndexValue(ti + 5, vi + (CircleData.PolygonQuantity * 2) + 1));
            return list;
        }
        ...
        protected override int DeriveInnerVertexIndex(int index) {
            return index + (CircleData.PolygonQuantity * 2);
        }
